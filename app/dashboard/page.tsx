          ...
          <main className="flex-1">
            ...
            {isLoading && (
              <div className="text-center py-12">
                ...
                <p className="mt-4 text-muted-foreground">Finding the best podcasts for you...</p>
              </div>
            )}
              ...
              <div className="space-y-4">
                {PODRANK_PICKS.map((pick) => (
                  <Link href={`/episode/${pick.id}`} key={pick.id}>
                    <Card className="group overflow-hidden transition-all duration-300 hover:ring-2 hover:ring-primary/20 hover:shadow-lg">
